...
public class PowerLevel : MonoBehaviour
{
    ...
    public int ReturnMyDancePowerLevel()
    {
        ...
        int sum = myLuck + myStyle + myRhthm;
        return sum; // instead of returning 0 we probably want to return our current power level
    }
    ...
    public float ReturnChanceToWin(int myPowerLevel,int opponentPowerLevel)
    {
        ...
        int chanceToWin = (myPowerLevel * 100) / totalPower;
