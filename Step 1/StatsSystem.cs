...
public class StatsSystem : MonoBehaviour
{
    ...
    public void DistributePhysicalStatsOnLevelUp(int PointsPool)
    {
        ...
        int streangthUp = Random.Range(0, 6);
        int agilityUp = Random.Range(0, 6);
        strength += streangthUp;
        PointsPool -= streangthUp;
        agility += agilityUp;
        PointsPool -= agilityUp;
        intelligence += PointsPool;
        CalculateDancingStats();
    }
