...
public class CharacterNameGenerator : MonoBehaviour
{
    ...
    public void CreateNames()
    {
        ...
        firstNames.Add("Ahemd");
        firstNames.Add("Basem");
        firstNames.Add("Khalid");
        firstNames.Add("Armaan");
        firstNames.Add("zakaria");
        firstNames.Add("micky");
        lastNames.Add("milky");
        lastNames.Add("hooka");
        lastNames.Add("shoora");
        lastNames.Add("sukar");
        lastNames.Add("salty");
        lastNames.Add("egghead");
        nicknames.Add("power Horse");
        nicknames.Add("Iron Man");
        nicknames.Add("Biryani Man");
        nicknames.Add("Nuke Guy");
        nicknames.Add("Sand Man");
        nicknames.Add("Corn Seller");
    }
